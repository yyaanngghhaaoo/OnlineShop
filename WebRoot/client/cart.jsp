			...
			<tr>
				<td>
					<table cellspacing="0" class="infocontent">
						<tr>
							<td><p>购物车&nbsp;>>&nbsp;订&nbsp;&nbsp;单&nbsp;&nbsp;(待支付)<p>
								<img src="${pageContext.request.contextPath}/client/images/registerSuccess.jpg" width="900" height="89" />
								<table border="0" cellspacing="0">
									<tr>
										<td>
										   <table cellspacing="1" class="carttable">
											...
											<div style="text-align:right; margin-top:10px">
											    <!--继续购物 -->
												<a href="${pageContext.request.contextPath}/showUserProductByPage?category=mobilephone">													
